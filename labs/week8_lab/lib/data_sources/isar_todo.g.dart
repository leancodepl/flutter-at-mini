...
IsarTodo _isarTodoDeserialize(
  ...
  final object = IsarTodo(
    done: reader.readBool(offsets[0]),
...
extension IsarTodoQueryFilter
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> doneEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdEqualTo(
    String value, {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'noteId',
        value: '',
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> noteIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'noteId',
        value: '',
...
extension IsarTodoQuerySortBy on QueryBuilder<IsarTodo, IsarTodo, QSortBy> {
  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.desc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByNoteId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteId', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByNoteIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTodoQuerySortThenBy
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.desc);
    });
  }
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByNoteId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteId', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByNoteIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteId', Sort.desc);
    });
  }
...
extension IsarTodoQueryWhereDistinct
  ...
  QueryBuilder<IsarTodo, IsarTodo, QDistinct> distinctByDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'done');
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QDistinct> distinctByNoteId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTodoQueryProperty
  ...
  QueryBuilder<IsarTodo, bool, QQueryOperations> doneProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'done');
    });
  }

  QueryBuilder<IsarTodo, String, QQueryOperations> noteIdProperty() {
    return QueryBuilder.apply(this, (query) {
