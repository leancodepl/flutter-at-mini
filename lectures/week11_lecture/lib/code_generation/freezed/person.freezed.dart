...
class _$PersonTearOff {
  ...
  _Person call({required String name, int age = 18}) {
    return _Person(
      name: name,
      age: age,
    );
...
class _$_Person implements _Person {
  _$_Person({required this.name, this.age = 18}) : assert(age >= 0);
...
abstract class _Person implements Person {
  factory _Person({required String name, int age}) = _$_Person;
